      ...
      <div className={styles.main}>
        <div className={styles.wave_bg}>
          <div className={styles.animation_box}>
            <TypeAnimation
              sequence={[
              'MedChain: A Decentralized Health Care Solution powered by Blockchain and Web3 Technology!!!',
              1000,
              'MedChain: Empowering Secure and Transparent Health Care through Blockchain and Web3!!!',
              1000,
              'MedChain: Revolutionizing Health Care through Blockchain and Web3 Technology!!!',
              1000,
              'MedChain: A Blockchain and Web3-based Health Care Platform for Secure and Efficient Care!!!',
              1000,
              'MedChain: A Blockchain and Web3-Powered Healthcare Network for Seamless Patient Care!!!',
              1000,
              'MedChain: Connecting Traditional Health Care with Blockchain and Web3 Technology!!!',
              1000,
              ]}
